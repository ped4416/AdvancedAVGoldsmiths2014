...
void FFT::setup(){//implementation of the setup() function of our object
...
//float FFT::playSounds(float x){//let channel of music
//    
...
//            lAudioOut[i] = x[i*nChannels    ] = outputs[0]*0.4;
//            rAudioOut[i] = x[i*nChannels + 1] = outputs[1]*0.4;
//        }
//        
//        /* Version2 */
